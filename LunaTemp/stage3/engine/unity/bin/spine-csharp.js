...
if ( TRACE ) { TRACE( "Spine.SkeletonClipping#ClipTriangles", this ); }
                ...
                var vertexBuffer = this.clippedVertices;
                var stride = 8;
                var length = vertexBuffer.length / stride * 2;

                this.ClippedUVs = new (Spine.ExposedList$1(System.Single)).ctor();
                var uv = this.ClippedUVs.Items;
                var vert = System.Array.init(length, 0, System.Single);
