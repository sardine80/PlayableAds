...
( () => {
    ...
    window.lunaStartup = {
        ...
        userFriendlyReport: function( totalTime, startupCount, avgStartupTime ) {
            ...
            runningTotal += this.timestamps[ 'luna:startup:shaderReady' ] - this.timestamps[ 'luna:startup:loadSimpleAssetsAsync' ];
            ...
            runningTotal += this.timestamps[ 'luna:startup:loadComplexAssetsAsync' ] - this.timestamps[ 'luna:startup:shaderReady' ];
            ...
            runningTotal += this.timestamps[ 'luna:started' ] - this.timestamps[ 'luna:startup:loadScenesAsync' ];
